				...
				<div class="deals">
					...
					<div class="deals_slider_container">
						...
						<div class="owl-carousel owl-theme deals_slider">
							...
							<c:forEach var="product" items="${getProductHotDealCover}">
								<a
									...
									<div class="owl-item deals_item">
										...
										<div class="deals_content">
											<div
												...
												<div class="deals_item_category">Headphones</div>
											...
											<div class="available">
												<div
													...
													<div class="available_title">
														Available: <span><c:out
																value="${product.available}" /></span>
													</div>
													<div class="sold_title ml-auto">
														Already sold: <span><c:out value="${product.sold}" /></span>
													</div>
												</div>
					...
					<div class="tabbed_container">
						...
						<div class="product_panel panel active">
							<div class="featured_slider slider">
								...
								<!-- Slider Item -->
								<c:forEach var="product" items="${getProductHotDeal}">
										...
										<a
											...
											<div
												...
												<ul class="product_marks">
													<li class="product_mark product_discount"><c:out
											...
											<div
												...
												<div class="product_content">
													...
													<div class="product_extras">
														...
														<a
											href="${pageContext.request.contextPath}/product/${product.id }"><button class="product_cart_button">Add to Cart</button></a>
													</div>
												</div>
												<div class="product_fav">
													<i class="fas fa-heart"></i>
