				...
				<div class="tabbed_container">
					...
					<div class="row">
						<div class="col-lg-9" style="z-index: 1;">
							...
							<div class="product_panel panel active">
								<div class="arrivals_slider slider">
									...
									<c:forEach var="product" items="${getProductHotNew}">
						...
						<div class="col-lg-3">
							...
							<a
												href="${pageContext.request.contextPath}/product/1">
								<div
									class="d-flex flex-column align-items-center justify-content-center">
									<div class="arrivals_single_image">
										<img src="resources/images/new_single.png" alt="">
									</div>
									<div class="arrivals_single_content">
										...
										<div class="arrivals_single_name_container clearfix">
											...
											<div class="arrivals_single_price text-right">8.000.000đ</div>
										</div>
